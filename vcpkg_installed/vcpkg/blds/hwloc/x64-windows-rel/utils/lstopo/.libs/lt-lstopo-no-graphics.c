...
const char * LIB_PATH_VALUE   = "D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\vcpkg\\blds\\hwloc\\x64-windows-rel\\hwloc\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\vcpkg\\blds\\hwloc\\x64-windows-rel\\hwloc\\.libs;D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\x64-windows\\lib;D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\x64-windows\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("d/vcpkg/blds/hwloc/x64-windows-rel/hwloc/libhwloc.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("s/hwloc/x64-windows-rel/hwloc/.libs:/D/Seneca/GPU/work/Final_Data_Analysis_Stoc", f);
  fputs ("k/vcpkg_installed/x64-windows/lib:/D/Seneca/GPU/work/Final_Data_Analysis_Stock/", f);
  fputs ("vcpkg_installed/x64-windows/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/Seneca/GPU/work/Final_Data_Analysis_Stock/vcpkg_installed/vcpkg/bl", f);
  fputs ("ds/hwloc/x64-windows-rel/hwloc/.libs:$PATH\"\n", f);
  fputs ("\n", f);

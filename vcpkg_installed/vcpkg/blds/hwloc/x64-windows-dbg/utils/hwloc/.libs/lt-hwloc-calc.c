...
/* ./.libs/lt-hwloc-calc.c - temporary wrapper executable for .libs/hwloc-calc.exe
   Generated by libtool (GNU libtool) 2.4.7

   The hwloc-calc program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "hwloc-calc.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# hwloc-calc - temporary wrapper script for .libs/hwloc-calc.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The hwloc-calc program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"hwloc-calc.exe:hwloc-calc:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hwloc-calc.exe:hwloc-calc:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hwloc-calc.exe:hwloc-calc:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);

...
/* ./.libs/lt-hwloc-patch.c - temporary wrapper executable for .libs/hwloc-patch.exe
   Generated by libtool (GNU libtool) 2.4.7

   The hwloc-patch program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "hwloc-patch.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# hwloc-patch - temporary wrapper script for .libs/hwloc-patch.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The hwloc-patch program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"hwloc-patch.exe:hwloc-patch:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hwloc-patch.exe:hwloc-patch:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hwloc-patch.exe:hwloc-patch:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);

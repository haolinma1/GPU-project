...
/* ./.libs/lt-hwloc-annotate.c - temporary wrapper executable for .libs/hwloc-annotate.exe
   Generated by libtool (GNU libtool) 2.4.7

   The hwloc-annotate program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "hwloc-annotate.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# hwloc-annotate - temporary wrapper script for .libs/hwloc-annotate.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The hwloc-annotate program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"hwloc-annotate.exe:hwloc-annotate:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hwloc-annotate.exe:hwloc-annotate:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hwloc-annotate.exe:hwloc-annotate:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='hwloc-annotate.exe'\n", f);

...
/* ./.libs/lt-hwloc-distrib.c - temporary wrapper executable for .libs/hwloc-distrib.exe
   Generated by libtool (GNU libtool) 2.4.7

   The hwloc-distrib program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "hwloc-distrib.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# hwloc-distrib - temporary wrapper script for .libs/hwloc-distrib.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The hwloc-distrib program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"hwloc-distrib.exe:hwloc-distrib:$LINENO: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hwloc-distrib.exe:hwloc-distrib:$LINENO: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hwloc-distrib.exe:hwloc-distrib:$LINENO: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='hwloc-distrib.exe'\n", f);

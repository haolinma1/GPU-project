...
/* ./.libs/lt-lstopo-no-graphics.c - temporary wrapper executable for .libs/lstopo-no-graphics.exe
   Generated by libtool (GNU libtool) 2.4.7

   The lstopo-no-graphics program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\vcpkg\\blds\\hwloc\\x64-windows-dbg\\hwloc\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\vcpkg\\blds\\hwloc\\x64-windows-dbg\\hwloc\\.libs;D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\x64-windows\\debug\\lib;D:\\Seneca\\GPU\\work\\Final_Data_Analysis_Stock\\vcpkg_installed\\x64-windows\\debug\\bin;";
const char * TARGET_PROGRAM_NAME = "lstopo-no-graphics.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# lstopo-no-graphics - temporary wrapper script for .libs/lstopo-no-graphics.ex", f);
  fputs ("e\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The lstopo-no-graphics program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("  notinst_deplibs=' /d/Seneca/GPU/work/Final_Data_Analysis_Stock/vcpkg_installe", f);
  fputs ("d/vcpkg/blds/hwloc/x64-windows-dbg/hwloc/libhwloc.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"lstopo-no-graphics.exe:lstopo-no-graphics:$LINENO: libtool wrapper (G", f);
  fputs ("NU libtool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lstopo-no-graphics.exe:lstopo-no-graphics:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lstopo-no-graphics.exe:lstopo-no-graphics:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='lstopo-no-graphics.exe'\n", f);
  ...
  fputs ("    PATH=/d/Seneca/GPU/work/Final_Data_Analysis_Stock/vcpkg_installed/vcpkg/bld", f);
  fputs ("s/hwloc/x64-windows-dbg/hwloc/.libs:/D/Seneca/GPU/work/Final_Data_Analysis_Stoc", f);
  fputs ("k/vcpkg_installed/x64-windows/debug/lib:/D/Seneca/GPU/work/Final_Data_Analysis_", f);
  fputs ("Stock/vcpkg_installed/x64-windows/debug/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/Seneca/GPU/work/Final_Data_Analysis_Stock/vcpkg_installed/vcpkg/bl", f);
  fputs ("ds/hwloc/x64-windows-dbg/hwloc/.libs:$PATH\"\n", f);
  fputs ("\n", f);

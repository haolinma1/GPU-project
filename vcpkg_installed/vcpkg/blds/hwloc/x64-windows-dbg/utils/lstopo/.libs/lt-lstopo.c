...
/* ./.libs/lt-lstopo.c - temporary wrapper executable for .libs/lstopo.exe
   Generated by libtool (GNU libtool) 2.4.7

   The lstopo program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "lstopo.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# lstopo - temporary wrapper script for .libs/lstopo.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The lstopo program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"lstopo.exe:lstopo:$LINENO: libtool wrapper (GNU libtool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lstopo.exe:lstopo:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lstopo.exe:lstopo:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
